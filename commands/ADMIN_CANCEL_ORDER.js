...
//
// PURPOSE:
// - Admin se order cancellation confirmation lena
// - Permanent cleanup se separate rakhna
// =====================================================
...
var currentStage = String(order.stage || "").toLowerCase();
var currentStatus = String(order.orderStatus || "").toLowerCase();
...
if (
  ...
  Api.sendMessage({
    chat_id: uid,
    text:
      "⚠️ <b>Completed order cancel nahi kiya ja sakta.</b>\n\n" +
      "Pehle delivery/payment status check karo.",
    parse_mode: "HTML",
    reply_markup: {
      inline_keyboard: [
        [
...
var text =
  ...
  "Cancellation se order permanently delete nahi hoga.\n" +
  "Order history mein record preserved rahega.\n\n" +
  ...
  [
    {
      ...
      callback_data: "ADMIN_CANCEL_ORDER_CONFIRM " + orderId
    }
  ],
  [
    {
