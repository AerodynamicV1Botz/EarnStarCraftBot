...
var clientData = Bot.getProperty(
  "USER_" + enquiry.userId
) || {}

clientData.enquiryStatus = "closed"
...
Api.sendMessage({
  ...
  text:
    ...
    "Your project enquiry has been closed by our team.\n\n" +

    "If you still need a bot or automation system, " +
    "you can submit a new enquiry anytime.",
